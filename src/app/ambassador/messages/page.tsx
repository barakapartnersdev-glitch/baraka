// بوّابة السفير: قائمة المحادثات الداخلية.
          ...
          {msgs.map((m) => (
            ...
            >
              <div className="min-w-0">
                ...
                <div className="text-xs text-gray-400">{t(`msg.type.${m.messageType}`)} · <span dir="ltr">{fmt(m.updatedAt)}</span></div>
              </div>
